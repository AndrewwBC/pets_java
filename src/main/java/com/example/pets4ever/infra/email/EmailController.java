...
public class EmailController {
    ...
    public ResponseEntity<EmailResponse> sendCodeToConfirmEmailUpdate(@PathVariable String email) {
    ...
    public ResponseEntity<EmailResponse> sendNewCodeToConfirmEmailUpdate(@PathVariable String email) {
